...
static const struct pin_index pins[] =
{
    ...
    __STM32_PIN_DEFAULT,        //     :  VREF+
    __STM32_PIN(22, A, 0),      // PA0 :  MOTOR_A      --> MOTOR
    __STM32_PIN(23, A, 1),      // PA1 :  MOTOR_B      --> MOTOR
    __STM32_PIN(24, A, 2),      // PA2 :  UART2_TX     --> EXTERNAL MODULE
    __STM32_PIN(25, A, 3),      // PA3 :  UART2_RX     --> EXTERNAL MODULE
    __STM32_PIN_DEFAULT,        //     :  VSS
    __STM32_PIN_DEFAULT,        //     :  VDD
    __STM32_PIN(28, A, 4),      // PA4 :  ADC12_IN9    --> EXTERNAL MODULE
    __STM32_PIN(29, A, 5),      // PA5 :  SPI1_SCK     --> SD_CARD
    __STM32_PIN(30, A, 6),      // PA6 :  SPI1_MISO    --> SD_CARD
    __STM32_PIN(31, A, 7),      // PA7 :  SPI1_MOSI    --> SD_CARD
    __STM32_PIN(32, C, 4),      // PC4 :  GBC_RX       --> ATK MODULE
    __STM32_PIN(33, C, 5),      // PC5 :  WIFI_INT     --> WIFI
    __STM32_PIN(34, B, 0),      // PB0 :  EMISSION     --> INFRARED EMISSION
    __STM32_PIN(35, B, 1),      // PB1 :  RECEPTION    --> INFRARED EMISSION
    __STM32_PIN(36, B, 2),      // PB2 :  BEEP         --> BEEP
    __STM32_PIN(37, E, 7),      // PE7 :  LED_R        --> LED
    __STM32_PIN(38, E, 8),      // PE8 :  LED_G        --> LED
    __STM32_PIN(39, E, 9),      // PE9 :  LED_B        --> LED
    __STM32_PIN(40, E, 10),     // PE10:  QSPI_BK1_CLK --> SPI_FLASH
    __STM32_PIN(41, E, 11),     // PE11:  QSPI_BK1_NCS --> SPI_FLASH
    __STM32_PIN(42, E, 12),     // PE12:  QSPI_BK1_IO0 --> SPI_FLASH
    __STM32_PIN(43, E, 13),     // PE13:  QSPI_BK1_IO1 --> SPI_FLASH
    __STM32_PIN(44, E, 14),     // PE14:  QSPI_BK1_IO2 --> SPI_FLASH
    __STM32_PIN(45, E, 15),     // PE15:  QSPI_BK1_IO3 --> SPI_FLASH
    __STM32_PIN(46, B, 10),     // PB10:  AP_INT       --> ALS&PS SENSOR
    __STM32_PIN(47, B, 11),     // PB11:  ICM_INT      --> AXIS SENSOR
    __STM32_PIN_DEFAULT,        //     :  VSS
    __STM32_PIN_DEFAULT,        //     :  VDD
    __STM32_PIN_DEFAULT,        //     :  VDD
